...
export default function ValentineForKajal() {
    const [isAccepted, setIsAccepted] = useState(false);
    const [noPos, setNoPos] = useState({ top: "65%", left: "50%" });

    const handleYes = () => {
        setIsAccepted(true);
        // Premium Hearts & Gold Confetti Celebration
    ...
    const moveNo = () => {
        // Button Kajal ke hath na aaye, isliye random movement
                ...
                {!isAccepted ? (
                    ...
                    >
                        ...
                        <h1 style={{
                            ...
                            Hello <span style={{ color: "#ff4b2b" }}>Kajal</span> ✨
                        </h1>
                        <p style={{
                            fontSize: "1.2rem",
                            color: "#5c5c5c",
